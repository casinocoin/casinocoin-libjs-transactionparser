...
the quotient of TakerPays/TakerGets. It uses drops (1e-6 CSC) for CSC values.
*/

function adjustQualityForCSC(quality, takerGetsCurrency, takerPaysCurrency) {
  var numeratorShift = (takerPaysCurrency === 'CSC' ? -6 : 0);
  var denominatorShift = (takerGetsCurrency === 'CSC' ? -6 : 0);
